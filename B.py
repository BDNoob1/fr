...
import time
os.system("clear")
print("  ==> \033[1;32mTHIS TOOLS  BY (ღ﹏𝐃𝐞𝐯𝐢𝐥﹏ღ) ")
print("  ==> \033[1;32m★IF YOU ARE BAD I'M 𝐃𝐞𝐯𝐢𝐥 YOUR DAD ★ ")
...
def hasil(ok,cp):
    if len(ok) != 0 or len(cp) != 0:
        ...
        if cek_cp =="":
            ...
            if ww in ("Y","y","ya"):
                ubahP.append("y")
                print(f" {N}[{H}â€¢{N}] Password example : {H}𝐃𝐞𝐯𝐢𝐥﹏123{N}")
